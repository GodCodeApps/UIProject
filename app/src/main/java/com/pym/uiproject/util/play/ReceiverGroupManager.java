...
import com.pym.uiproject.util.cover.CompleteCover;
import com.pym.uiproject.util.cover.ControllerCover;
import com.pym.uiproject.util.cover.ErrorCover;
import com.pym.uiproject.util.cover.GestureCover;
import com.pym.uiproject.util.cover.LoadingCover;

import static com.pym.uiproject.util.play.DataInter.ReceiverKey.KEY_COMPLETE_COVER;
import static com.pym.uiproject.util.play.DataInter.ReceiverKey.KEY_CONTROLLER_COVER;
import static com.pym.uiproject.util.play.DataInter.ReceiverKey.KEY_ERROR_COVER;
import static com.pym.uiproject.util.play.DataInter.ReceiverKey.KEY_GESTURE_COVER;
import static com.pym.uiproject.util.play.DataInter.ReceiverKey.KEY_LOADING_COVER;
