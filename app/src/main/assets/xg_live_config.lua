...
-- 点赞坐标
LIVE_DIGG_COORDINATE = {x = -42, y = 52, origin_x = 1, origin_y = 0}

-- 点赞样式 1:火山现有样式 2:西瓜直播样式
LIVE_DIGG_STYLE = 3
...
LIVE_NORMAL_GIFT_NUMBER_OUT_SIZE_FACTOR = 1.3

LIVE_NORMAL_GIFT_NUMBER_ANIMATION_OUT_DURATION = 0.07

LIVE_NORMAL_GIFT_NUMBER_ANIMATION_IN_DURATION = 0.38